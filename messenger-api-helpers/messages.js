...
const createAccountMessage = {
  attachment: {
    ...
    payload: {
      ...
      text: 'Ready to do this? You’ll need to log in to your Hello Fresh account so I can access your past orders.',
...
const signOutSuccessMessage = {
  attachment: {
    ...
    payload: {
      template_type: 'button',
      text: 'You’ve been logged out of your Hello Fresh account.',
      buttons: [signInButton],
    },
  },
};
